...
<?php
		...
		if (mysql_query ( "UPDATE customers SET username = '$uname', password = '$upass', email = '$email', mobile = '$mobile', area = $area_id WHERE id = $_GET[id]" )) {
			?>
...
<center>
	<form method="post">
		<table align="center" width="50%" border="0" id="form_table">
			...
			<tr>
				<td>Area : <select name="area_id" class="form-control"> 
