...
<?php
$query = "SELECT follow.*, customers.*, customers.id AS customer_id FROM follow LEFT JOIN customers ON customers.id = follow.user_id WHERE follow.follow_id = $_SESSION[user_id]";
...
<center>
	<table align="center" width="100%" border="0" id="form_table">
		...
		<tr align="center">
			...
			<td><a href="unfollow.php?id=<?php echo $member_row[customer_id]?>">Unfollow</a></td>
		</tr>
			<?php }?>
	</table>
</center>
